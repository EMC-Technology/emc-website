...
本项目采用 **CC BY-NC-SA 4.0**（知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议）授权。贡献本项目即表示您同意：

- 您的贡献将采用相同的 CC BY-NC-SA 4.0 协议授权
- 您的贡献仅用于非商业目的
- 您保留对您贡献部分的原始著作权
...
本项目及其所有贡献均受 CC BY-NC-SA 4.0 许可证保护。详细信息请参阅 [LICENSE](LICENSE) 文件。
