...
fn test_full_error_handling_flow() {
    ...
    // 测试用户提示
    let prompt = UserPromptManager::default().get_error_prompt(Severity::ERROR, "User not found", Some("zh-CN"));
...
fn test_error_propagation_chain() {
    ...
    let propagated_error = error_core::error_capture::ErrorPropagation::wrap_error(business_error, root_error);
