...
fn test_recovery_state_machine() {
    ...
    let test_cases = vec![
        ...
        (
            "max_attempts",
            100,
            RetryConfig::new(100, 1000, 10000, 2.0, true),
        ),
...
fn test_recovery_state_machine_edge_cases() {
    ...
    let retry_config_max = RetryConfig::new(3, 1000, 2000, 2.0, false);
...
fn test_recovery_all_combinations() {
    ...
    let reset_timeouts = [Duration::from_millis(10), Duration::from_millis(100)];
